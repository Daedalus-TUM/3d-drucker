...
// ./createTemperatureLookupMarlin.py --rp=4700 --t1=25.0:93217.0 --t2=150.0:2131.0 --t3=265.0:262.0 --num-temps=36
// Steinhart-Hart Coefficients: 0.000599525136766344, 0.000221490483970855,  1.46868402113347e-07 
   {(short)(18.85*OVERSAMPLENR), 350}, // v=0.092035638136 r=88.1358272689 res=4.67929889812 C/count
   {(short)(21.07*OVERSAMPLENR), 340}, // v=0.102871832644 r=98.7308473263 res=4.0843577296 C/count
   {(short)(23.62*OVERSAMPLENR), 330}, // v=0.115350808137 r=110.990324371 res=3.5524213273 C/count
   {(short)(26.58*OVERSAMPLENR), 320}, // v=0.129769024743 r=125.233160273 res=3.07870904109 C/count
   {(short)(30.00*OVERSAMPLENR), 310}, // v=0.146483419023 r=141.850152961 res=2.65858007457 C/count
   {(short)(33.98*OVERSAMPLENR), 300}, // v=0.16592463816 r=161.322640004 res=2.28755401146 C/count
   {(short)(38.63*OVERSAMPLENR), 290}, // v=0.188613136945 r=184.246615139 res=1.96132890328 C/count
   {(short)(44.07*OVERSAMPLENR), 280}, // v=0.215178624743 r=211.364115183 res=1.67579681614 C/count
   {(short)(50.46*OVERSAMPLENR), 270}, // v=0.246383319825 r=243.604329312 res=1.42705678605 C/count
   {(short)(57.99*OVERSAMPLENR), 260}, // v=0.283149333469 r=282.137799432 res=1.21142518282 C/count
   {(short)(66.89*OVERSAMPLENR), 250}, // v=0.326590182645 r=328.448374617 res=1.02544353292 C/count
   {(short)(77.42*OVERSAMPLENR), 240}, // v=0.378045786479 r=384.429424085 res=0.865883901435 C/count
   {(short)(89.93*OVERSAMPLENR), 230}, // v=0.439119140095 r=452.513455589 res=0.729751982884 C/count
   {(short)(104.80*OVERSAMPLENR), 220}, // v=0.511710900806 r=535.848110635 res=0.614288101768 C/count
   {(short)(122.48*OVERSAMPLENR), 210}, // v=0.598045009818 r=638.537093726 res=0.516966378743 C/count
   {(short)(143.50*OVERSAMPLENR), 200}, // v=0.700673834857 r=765.972828609 res=0.435492380932 C/count
   {(short)(168.44*OVERSAMPLENR), 190}, // v=0.822444949043 r=925.299897512 res=0.367799651511 C/count
   {(short)(197.92*OVERSAMPLENR), 180}, // v=0.966403933392 r=1126.0667682 res=0.312045613491 C/count
   {(short)(232.57*OVERSAMPLENR), 170}, // v=1.13560022228 r=1381.15136935 res=0.266607480297 C/count
   {(short)(272.95*OVERSAMPLENR), 160}, // v=1.33276017557 r=1708.08922379 res=0.230079004017 C/count
   {(short)(319.45*OVERSAMPLENR), 150}, // v=1.55980090763 r=2131.0 res=0.201269187156 C/count
   {(short)(372.16*OVERSAMPLENR), 140}, // v=1.8171905947 r=2683.41415005 res=0.179204533166 C/count
   {(short)(430.74*OVERSAMPLENR), 130}, // v=2.1032251069 r=3412.47020124 res=0.163137109115 C/count
   {(short)(494.26*OVERSAMPLENR), 120}, // v=2.4133831706 r=4385.22659131 res=0.152561796445 C/count
   {(short)(561.15*OVERSAMPLENR), 110}, // v=2.74001098821 r=5698.28064535 res=0.147247875086 C/count
   {(short)(629.27*OVERSAMPLENR), 100}, // v=3.07260697244 r=7492.63516264 res=0.147292971357 C/count
   {(short)(696.09*OVERSAMPLENR), 90}, // v=3.39885749213 r=9977.01961847 res=0.153212185913 C/count
   {(short)(759.05*OVERSAMPLENR), 80}, // v=3.7063071997 r=13465.0543271 res=0.166083305125 C/count
   {(short)(815.97*OVERSAMPLENR), 70}, // v=3.98424368687 r=18435.4702857 res=0.187782949679 C/count
   {(short)(865.33*OVERSAMPLENR), 60}, // v=4.22522610808 r=25631.4299116 res=0.221373147458 C/count
   {(short)(906.41*OVERSAMPLENR), 50}, // v=4.42581319307 r=36227.4468105 res=0.271742504538 C/count
   {(short)(939.29*OVERSAMPLENR), 40}, // v=4.58638110171 r=52115.5857894 res=0.346689847652 C/count
   {(short)(964.66*OVERSAMPLENR), 30}, // v=4.7102584563 r=76406.7674318 res=0.458801206479 C/count
   {(short)(983.57*OVERSAMPLENR), 20}, // v=4.80256928473 r=114329.098225 res=0.628804294461 C/count
   {(short)(997.20*OVERSAMPLENR), 10}, // v=4.86913723045 r=174877.431238 res=0.891810458047 C/count
   {(short)(1006.73*OVERSAMPLENR), 0}  // v=4.91565654833 r=273922.697265 res=1.30957218456 C/count
};
*/
#endif
